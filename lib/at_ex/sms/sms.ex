defmodule AtEx.Sms.Sms do
  ...
  ## Parameters
  attrs: - a map containing a `to` and `message` key optionally it may also contain `from`, bulkSMSMode, enqueue, keyword
  ...
  defp get_token_url do
    cond do
      Application.get_env(:at_ex, :endpoint, "sandbox") === "production" -> @live_token_url
      Application.get_env(:at_ex, :endpoint, "sandbox") === "sandbox" -> @sandbox_token_url
